...
DRBR=(BNRBR(5,:)-BNRatio)./BNRatio;

X1=[1:420];
YMatrix1=[DREB(1:420);DRLB(1:420);DRPB(1:420);DRNB(1:420);DRHB(1:420);DRFB(1:420)];
X2=[440:720];
YMatrix2=[DREB(440:720);DRLB(440:720);DRPB(440:720);DRNB(440:720);DRHB(440:720);DRFB(440:720)];
X3=[800:1080];
YMatrix3=[DREB(800:1080);DRLB(800:1080);DRPB(800:1080);DRNB(800:1080);DRHB(800:1080);DRFB(800:1080)];
